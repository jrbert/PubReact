...
const Main = () => {
    return (
        <Conteudo>
            ...
            <div id="pratos1e2">
            <a href="/cardapio"><img id="prato1" src="https://i.ibb.co/23CFZrP/Roast-Beef.jpg"/></a>
            <a href="/cardapio"><img id="prato2" src="https://i.ibb.co/wsvbxNg/Fish-And-Chips.jpg"/></a>
            </div>
                <div id="pratos3e4">
            <a href="/cardapio"><img id="prato3" src="https://i.ibb.co/K6SCyZt/Bangers-And-Mash.jpg"/></a>
            <a href="/cardapio"><img id="prato4" src="https://i.ibb.co/9sqZn85/Blue-Cheese-Burguer.jpg"/></a>
            </div>
        
            <div class="aside">
                <div id="bebidas">
                <a href="/cardapio"><img id="be1" src="https://i.ibb.co/0rLwX5W/Pina-Colada.png"/></a>  
                    <p id="tb">Piña Colada</p>
                <a href="/cardapio"><img id="be2" src="https://i.ibb.co/mHFq8xf/Mojito.png"/></a> 
                    <p id="tb">Mojito</p>
                <a href="/cardapio"><img id="be3" src="https://i.ibb.co/hHJQJtC/Cuba-Libre.png"/></a>
                    <p id="tb">Cuba Libre</p>
                <a href="/cardapio"><img id="be4" src="https://i.ibb.co/X2x0mDP/Bloody-Mary.png"/></a>
            ...
            <div id="info">
                ...
                <div>
                   <a href="/equipe"><h3 class ="equipe">Equipe</h3></a> 
